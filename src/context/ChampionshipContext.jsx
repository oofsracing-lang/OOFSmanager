...
export const ChampionshipProvider = ({ children }) => {
    ...
    const exportSeasonData = () => {
        ...
        // This object structure is identical to what the app expects to load from season3.json
        const exportObj = {
            ...seasonData,
            penalties: penalties,
        ...
        downloadAnchorNode.setAttribute("download", `season${currentSeasonId}_full_export.json`);
